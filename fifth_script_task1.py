...
def letter_stat(our_str):
    """
Метод принимает на вход строку и возвращает словарь
с ключом-буквой строки и значением-количеством повторений буквы в строке
    :param our_str: Строка текста
    :return: Словарь с ключом буквой и значением количеством повторений буквы
    """
