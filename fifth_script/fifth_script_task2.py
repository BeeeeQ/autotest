...
def repeats(our_str):
    """
Метод принимает на вход строку и возвращает строку, добавляя к каждой букве _n, где
n - количество использований буквы в строке
    :param our_str: Строка текста
    :return: Строка с _n, где n - количество использований буквы в строке
    """
    ...
    for i in our_str:
        ...
        new_str += i + f'_{letters_dict.get(i)}'
    return new_str
